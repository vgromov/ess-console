...
public:
  ...
  ES_DECL_INTF_METHOD(void, emptyContentsInit)();

  /// Non-reflected services
  ///
  virtual bool doRead(cr_EsVariant params) ES_OVERRIDE;
  virtual void doWrite(cr_EsVariant key, cr_EsVariant params) ES_OVERRIDE;
...
private:
  EsCompiledScriptDocument(const EsCompiledScriptDocument&) ES_REMOVEDECL;
  EsCompiledScriptDocument& operator=(const EsCompiledScriptDocument&) ES_REMOVEDECL;
};
