...
wxMenuPtr EsTextEditorViewBase::ctxMenuGet()
{
  if(m_pmnu)
    return m_pmnu;
...
wxMenuPtr EsTextEditorViewBase::customCtxMenuGet()
{
  if(!m_pmnuCtx)
  {
    doCustomCtxMenuInit();
...
void EsTextEditorViewBase::ctxMenuInit()
{
  ...
  wxMenuPtr customCtx = customCtxMenuGet();
  if(customCtx)
  {
...
void EsTextEditorViewBase::doCtxMenuStringsUpdate(wxMenu* pmnu)
{
  ...
  pmnu->SetLabel(
    EsSconsoleCmds::usrID_EDIT_GOTO_CLOSING_BRACE,
    _("To closing brace\tCTRL-]")
  );
  pmnu->SetHelpString(
    EsSconsoleCmds::usrID_EDIT_GOTO_CLOSING_BRACE,
    _("Jump to corresponding closing brace")
  );

  pmnu->SetLabel(
    EsSconsoleCmds::usrID_EDIT_GOTO_OPENING_BRACE,
    _("To opening brace\tCTRL-[")
  );
  pmnu->SetHelpString(
    EsSconsoleCmds::usrID_EDIT_GOTO_OPENING_BRACE,
    _("Jump to corresponding opening brace")
  );
}
//--------------------------------------------------------------------------------
