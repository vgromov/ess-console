...
/// Common directory list editor doalog
///
...
private:
  EsPathsListDlg() ES_REMOVEDECL;
  EsPathsListDlg(const EsPathsListDlg&) ES_REMOVEDECL;
  EsPathsListDlg& operator=(const EsPathsListDlg&) ES_REMOVEDECL;
};
