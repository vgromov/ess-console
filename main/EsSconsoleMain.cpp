...
EsEventSubscriber(
  ES_EVTC_APPLICATION ES_EVTC_AND
  ES_EVTC_MDI ES_EVTC_AND
  ES_EVTC_COMPILER_THREAD ES_EVTC_AND
...
bool EsSconsoleMain::Show(bool show /*= true*/)
{
  const EsSconsoleCommandLineParams& params = wxGetApp().cmdlineParamsGet();

  if(
    show && 
    params.m_startMinimized
  )
    Iconize();
...
EsAssocContainerIntf::Ptr EsSconsoleMain::settingsToCompiledScriptDocumentParams(const EsString& key /*= EsString::null()*/)
{
  ...
  aparams->newValueSet(
    esVT("retainDebug"),
    wxGetApp().scriptParamsAccess().m_inclDebugInfo
  );

  aparams->newValueSet(
    esVT("translatablesSave"),
    wxGetApp().scriptParamsAccess().m_translatablesSave
  );
...
void EsSconsoleMain::mnuFileInit()
{
  ...
  m_mnuFile->Append(
    wxID_NEW,
    _("&New script file\tCTRL-N").as<wxString>(),
    _("Create new script file").as<wxString>()
  );

  m_mnuFile->Append(
    wxID_OPEN,
    _("&Open\tCTRL-O").as<wxString>(),
    _("Open existing source or compiled script files").as<wxString>()
  );
  m_mnuFile->AppendSeparator();
  m_mnuFile->Append(
    wxID_CLOSE,
    _("Close").as<wxString>(),
    _("Close currently active file").as<wxString>()
  );
  m_mnuFile->Append(
    wxID_CLOSE_ALL,
    _("Close all").as<wxString>(),
    _("Close all open files").as<wxString>()
  );
  m_mnuFile->AppendSeparator();
  m_mnuFile->Append(
    wxID_SAVE,
    _("&Save\tCTRL-S").as<wxString>(),
    _("Save changes to the currently active file").as<wxString>()
  );
  m_mnuFile->Append(
    wxID_SAVEAS,
    _("Save as...").as<wxString>(),
    _("Save current file with different file name").as<wxString>()
  );
  m_mnuFile->Append(
    usrID_SAVE_ALL,
    _("Save all\tCTRL-SHIFT-S").as<wxString>(),
    _("Save all changes to opened files").as<wxString>()
  );
  m_mnuFile->AppendSeparator();
  ...
  m_mnuFileMRU->Append(
    usrID_MRU_CLEAR,
    _("Clear history").as<wxString>(),
    _("Empty recent files list").as<wxString>()
  );

  m_mnuFile->AppendSubMenu(
    m_mnuFileMRU,
    _("Recent files").as<wxString>()
  );
  ...
  m_mnuFile->Append(
    wxID_EXIT,
    _("Exit\tALT-F4").as<wxString>(),
    _("Exit application").as<wxString>()
  );
...
void EsSconsoleMain::mnuEditInit()
{
  ...
  m_mnuEdit->Append(
    wxID_UNDO,
    _("Undo").as<wxString>(),
    _("Undo recent changes").as<wxString>()
  );
  m_mnuEdit->Append(
    wxID_REDO,
    _("Redo").as<wxString>(),
    _("Redo recent changes").as<wxString>()
  );
  m_mnuEdit->AppendSeparator();
  m_mnuEdit->Append(
    wxID_SELECTALL,
    _("Select All\tCTRL-A").as<wxString>(),
    _("Select All content in current document").as<wxString>()
  );
  m_mnuEdit->Append(
    wxID_COPY,
    _("Copy\tCTRL-C").as<wxString>(),
    _("Copy current selection to a clipboard").as<wxString>()
  );
  m_mnuEdit->Append(
    wxID_CUT,
    _("Cut\tCTRL-X").as<wxString>(),
    _("Cut current selection to clipboard").as<wxString>()
  );
  m_mnuEdit->Append(
    wxID_PASTE,
    _("Paste\tCTRL-V").as<wxString>(),
    _("Paste clipboard contents to current document").as<wxString>()
  );
  m_mnuEdit->AppendSeparator();
  m_mnuEdit->Append(
    wxID_FIND,
    _("Find\tCTRL-F").as<wxString>(),
    _("Find subject in documents").as<wxString>()
  );
  m_mnuEdit->Append(
    wxID_REPLACE,
    _("Replace\tCTRL-R").as<wxString>(),
    _("Find subject in documents and replace it with new content").as<wxString>()
  );
  ...
  m_mnuEditBm->Append(
    ...
    _("Clear all bookmarks\tCTRL-SHIFT-B").as<wxString>(),
    _("Clear all bookmarks in current Document").as<wxString>()
  );
  m_mnuEditBm->AppendSeparator();
  m_mnuEditBm->Append(
    usrID_EDIT_BOOKMARK,
    _("Bookmark\tCTRL-B").as<wxString>(),
    _("Toggle bookmark").as<wxString>()
  );
  m_mnuEditBm->AppendSeparator();
  for(int idx = usrID_EDIT_BOOKMARK0; idx <= usrID_EDIT_BOOKMARK9; ++idx)
  {
    ...
    m_mnuEditBm->AppendCheckItem(
      idx,
      wxString::Format(
        _("Bookmark %d\tALT-%d").as<wxString>(),
        num,
        num
      ),
      wxString::Format(
        _("Toggle bookmark %d").as<wxString>(),
        num
      )
    );
  }
  ...
  m_mnuEditBm->Append(
    ...
    _("Next Bookmark\tF2").as<wxString>(),
    _("Goto next bookmark").as<wxString>()
  );
  m_mnuEditBm->Append(
    usrID_EDIT_BOOKMARK_PREV,
    _("Previous Bookmark\tCTRL-SHIFT-F2").as<wxString>(),
    _("Goto next bookmark").as<wxString>()
  );
  m_mnuEditBm->AppendSeparator();
  for(int idx = usrID_EDIT_GOTO_BOOKMARK0; idx <= usrID_EDIT_GOTO_BOOKMARK9; ++idx)
  {
    ...
    m_mnuEditBm->Append(
      idx,
      wxString::Format(
        _("Goto %d\tCTRL-%d").as<wxString>(),
        num, num
      ),
      wxString::Format(
        _("Goto bookmark %d").as<wxString>(),
        num
      )
    );
  }
  ...
  m_mnuEdit->AppendSubMenu(
    m_mnuEditBm,
    _("Bookmarks").as<wxString>(),
    _("Document bookmarks control and navigation").as<wxString>()
  );
...
void EsSconsoleMain::mnuScriptInit()
{
  ...
  m_mnu->Append(
    m_mnuScript,
    _("&Script").as<wxString>()
  );

  m_mnuScript->Append(
    usrID_COMPILE_BREAK,
    _("Compile").as<wxString>()
  );
  m_mnuScript->AppendSeparator();
  m_mnuScript->Append(
    usrID_RUN,
    _("Run\tALT-F9").as<wxString>(),
    _("Run compiled script").as<wxString>()
  );
  m_mnuScript->AppendSeparator();
  m_mnuScript->Append(
    usrID_DEBUG,
  ...
  m_mnuScript->Append(
    usrID_DEBUG_STEP,
    _("Step\tF8").as<wxString>(),
    _("Step-by-step script instruction execution in debugger").as<wxString>()
  );
  m_mnuScript->AppendSeparator();
  m_mnuScript->Append(
    usrID_RUN_ABORT,
    _("Abort\tCTRL-F2").as<wxString>(),
    _("Abort script execution").as<wxString>()
  );
...
void EsSconsoleMain::mnuOptionsInit()
{
  ...
  m_mnu->Append(
    m_mnuOptions,
    _("&Options").as<wxString>()
  );

  m_mnuOptions->AppendCheckItem(
    usrID_OPT_INCLUDE_DEBUG,
    _("Include debug").as<wxString>(),
    _("Include debug information, when saving compiled script document").as<wxString>()
  );
  m_mnuOptions->AppendCheckItem(
    usrID_OPT_GENERATE_TRANSLATABLES,
    _("Generate translatables").as<wxString>(),
    _("Generate translatable strings file, when saving compiled script document").as<wxString>()
  );
  m_mnuOptions->AppendSeparator();
  m_mnuOptions->Append(
    usrID_OPT_INC_PATHS,
    _("Include paths...").as<wxString>(),
    _("Set-up list of script include look-up directories for ##require(...) to search in").as<wxString>()
  );
  m_mnuOptions->Append(
    usrID_OPT_LINK_PATHS,
    _("Link paths...").as<wxString>(),
    _("Set-up list of binary look-up paths for script ##link(...) to search in").as<wxString>()
  );
  m_mnuOptions->AppendSeparator();
  m_mnuOptions->AppendCheckItem(
    usrID_OPT_DBGLOG_SUPPRESSION,
    _("Use Debug Log suppression").as<wxString>(),
    _("Toggle Debug Log suppression for compiled code").as<wxString>()
  );
  m_mnuOptions->Append(
    usrID_OPT_DBGLOG_SUPPRESSION_RULES,
    _("Debug Log suppression rules").as<wxString>(),
    _("Set-up rules for selective EsScriptDebug::log code suppression").as<wxString>()
  );
  ...
  m_mnuOptions->AppendSubMenu(
    mnuLangs,
    _("Select language").as<wxString>(),
    _("Select user interface language").as<wxString>()
  );
}
//--------------------------------------------------------------------------------
...
void EsSconsoleMain::mnuOptionsEvtHandlersInit()
{
  ...
  Bind(wxEVT_MENU, &EsSconsoleMain::onOptDbgLogSuppress, this, usrID_OPT_DBGLOG_SUPPRESSION);
  Bind(wxEVT_MENU, &EsSconsoleMain::onOptDbgLogRules, this, usrID_OPT_DBGLOG_SUPPRESSION_RULES);
  ...
  Bind(wxEVT_UPDATE_UI, &EsSconsoleMain::onOptionsUiUpdate, this, usrID_OPT_INCLUDE_DEBUG, usrID_OPT_DBGLOG_SUPPRESSION_RULES);
...
void EsSconsoleMain::mnuWindowInit()
{
  ...
  m_mnu->Append(
    m_mnuWindow,
    _("&Window").as<wxString>()
  );

  m_mnuWindow->AppendCheckItem(
    usrID_WND_LIST,
    _("Document list").as<wxString>(),
    _("Toggle document list pane visibility").as<wxString>()
  );
  ...
  m_mnuWindow->AppendCheckItem(
    usrID_WND_APPLOG,
    _("Application Log").as<wxString>(),
    _("Toggle application log pane visibility").as<wxString>()
  );
  m_mnuWindow->AppendCheckItem(
    usrID_WND_COMPILELOG,
    _("Compiler Log").as<wxString>(),
    _("Toggle script compiler log pane visibility").as<wxString>()
  );
...
void EsSconsoleMain::mnuHelpInit()
{
  ...
  m_mnuHelp->Append(
    ...
    _("About...").as<wxString>(),
    wxString::Format(
      _("Show information about an '%s' application").as<wxString>(),
      PRODUCT_NAME
    )
  );
  m_mnuHelp->Append(
    ...
    _("Help...").as<wxString>(),
    wxString::Format(
      _("Show help on '%s' application").as<wxString>(),
      PRODUCT_NAME
    )
  );
  ...
  m_mnuHelp->Append(
    usrID_HLP_ESCORE,
    _("ES core").as<wxString>(),
    _("Show ES core API documentation, including reflection").as<wxString>()
  );
  m_mnuHelp->Append(
    usrID_HLP_ESCOMM,
    _("ES comm").as<wxString>(),
    _("Show ES comm API documentation, including reflection").as<wxString>()
  );
  m_mnuHelp->Append(
    usrID_HLP_ESMATH,
    _("ES math").as<wxString>(),
    _("Show ES math API documentation, including reflection").as<wxString>()
  );
  m_mnuHelp->Append(
    usrID_HLP_ESSCRIPT,
    _("ES script").as<wxString>(),
    _("Show ES script API documentation, including reflection").as<wxString>()
  );
  m_mnuHelp->Append(
    usrID_HLP_ESSCRIPTING,
    _("ES scripting cookbook").as<wxString>(),
    _("Show documentation on ES script language basics, with small examples").as<wxString>()
  );
#if defined(__WXMSW__)
  m_mnuHelp->AppendSeparator();
  m_mnuHelp->AppendCheckItem(
    usrID_HLP_AUTO_UPDATE,
    _("Auto update").as<wxString>(),
    _("Toggle automatic regular checking for an application updates").as<wxString>()
  );
  m_mnuHelp->Append(
    usrID_HLP_UPDATE,
    _("Check for update").as<wxString>(),
    _("Check for online application updatesmanually").as<wxString>()
  );
#endif
...
void EsSconsoleMain::layoutInit()
{
  ...
  m_mgrAui.AddPane(
    ...
    Layer(1).
    Caption(_("Compiler output log").as<wxString>()).
    MinSize(
  ...
  m_mgrAui.AddPane(
    ...
    Layer(1).
    Caption(_("Application Log").as<wxString>()).
    MinSize(
      wxSystemOptions::GetOptionInt(ES_APP_OPT_PANE_MIN_WIDTH),
      wxSystemOptions::GetOptionInt(ES_APP_OPT_PANE_MIN_HEIGHT)
    ).
  ...
  m_mgrAui.AddPane(
    ...
    Layer(1).
    Caption(_("Open documents list").as<wxString>()).
    MinSize(
      wxSystemOptions::GetOptionInt(ES_APP_OPT_PANE_MIN_WIDTH),
      wxSystemOptions::GetOptionInt(ES_APP_OPT_PANE_MIN_HEIGHT)
    ).
  ...
  if(needCreate)
  {
    ...
    if(replace)
      m_dlgFr = new wxFindReplaceDialog(
        this,
        &m_dataFr,
        _("Find and Replace text").as<wxString>(),
        wxFR_REPLACEDIALOG
      );
    else
      m_dlgFr = new wxFindReplaceDialog(
...
void EsSconsoleMain::scriptCompiationTextUpdate()
{
  ...
  if( !m_compiling )
  {
    item->SetItemLabel(_("Compile\tCTRL-F9").as<wxString>());
    item->SetHelp(_("Compile currently active script file").as<wxString>());
  }
  else
  {
    item->SetItemLabel(_("Break\tCTRL-F9").as<wxString>());
    item->SetHelp(_("Break currently running compilation").as<wxString>());
  }
...
void EsSconsoleMain::scriptDebugLabelsAndIconsUpdate()
{
  ...
  {
    lbl = _("Pause\tF9").as<wxString>();
    hlp = _("Pause debugger at current execution point").as<wxString>();
    bm = wxArtProvider::GetBitmap(esART_DEBUG_PAUSE);
  }
  else if( binaryScriptIsDebugging() && !binaryScriptIsContinuouslyDebugging() )
  {
    lbl =_("Continue\tF9").as<wxString>();
    hlp = _("Continue script execution in debugger").as<wxString>();
    bm = wxArtProvider::GetBitmap(esART_DEBUG_RUN);
  }
  else
  {
    lbl = _("Debug\tF9").as<wxString>();
    hlp = _("Run compiled script in debugger").as<wxString>();
    bm = wxArtProvider::GetBitmap(esART_DEBUG_RUN);
  }
...
void EsSconsoleMain::onOptionsUiUpdate(wxUpdateUIEvent& evt)
{
  ...
  case usrID_OPT_DBGLOG_SUPPRESSION_RULES:
    evt.Enable(
      !m_compiling && !binaryScriptIsRunning()
    );
    break;
  case usrID_OPT_DBGLOG_SUPPRESSION:
    evt.Check(
      wxGetApp().scriptParamsAccess().m_debugLogSuppress
    );
    evt.Enable(
      !m_compiling && !binaryScriptIsRunning()
    );
...
void EsSconsoleMain::onFileOpen(wxCommandEvent& WXUNUSED(evt))
{
  ...
  for(auto const& regType : regTypes)
  {
    ...
    filterStr += regInfo[esVT("filterStr")][1].asString().as<wxString>();
  }

  wxFileDialog dlgOpen(
    this,
    _("Open file").as<wxString>(),
    wxEmptyString,
    wxEmptyString,
    filterStr,
...
void EsSconsoleMain::onOptIncludeDebug(wxCommandEvent& ES_UNUSED(evt))
{
  ...
  wxGetApp().scriptParamsAccess().m_inclDebugInfo = !wxGetApp().scriptParamsAccess().m_inclDebugInfo;
...
void EsSconsoleMain::onOptGenTranslatables(wxCommandEvent& ES_UNUSED(evt))
{
  ...
  wxGetApp().scriptParamsAccess().m_translatablesSave = !wxGetApp().scriptParamsAccess().m_translatablesSave;
  commonAppSettingsApply(true);
}
//--------------------------------------------------------------------------------
...
void EsSconsoleMain::onOptIncludePaths(wxCommandEvent& evt)
{
  ...
  dlg.foldersSet(
    wxGetApp().scriptParamsAccess().m_includes
  );
    ...
    [this](const EsDlgBase& Sender, int modalResult)
  {
    ...
    {
      wxGetApp().scriptParamsAccess().m_includes = static_cast<const EsPathsListDlg&>(Sender).foldersGet();
      commonAppSettingsApply(true);
    }
  }
  );
...
void EsSconsoleMain::onOptLinkPaths(wxCommandEvent& ES_UNUSED(evt))
{
  ES_ASSERT(!binaryScriptIsRunning());
  ...
  dlg.foldersSet(
    wxGetApp().scriptParamsAccess().m_linkPaths
  );
    ...
    [this](const EsDlgBase& Sender, int modalResult)
  {
    if(wxID_OK == modalResult)
    {
      wxGetApp().scriptParamsAccess().m_linkPaths = static_cast<const EsPathsListDlg&>(Sender).foldersGet();
      commonAppSettingsApply(true);
    }
  }
  );
...
void EsSconsoleMain::onOptDbgLogSuppress(wxCommandEvent& ES_UNUSED(evt))
{
  wxGetApp().scriptParamsAccess().m_debugLogSuppress =
    !wxGetApp().scriptParamsAccess().m_debugLogSuppress;
  commonAppSettingsApply(true);
...
void EsSconsoleMain::onOptDbgLogRules(wxCommandEvent& ES_UNUSED(evt))
{
  ES_ASSERT(!binaryScriptIsRunning());

  EsDbgLogRulesDlg dlg( this );

  const EsScriptParameters& cparams = wxGetApp().scriptParamsAccess();
  dlg.inclIsFirstSet(
    cparams.m_dbgLogSuppressInclFirst
  );
  dlg.rulesInclSet(
    cparams.m_dbgLogSuppressIncl
  );
  dlg.rulesExclSet(
    cparams.m_dbgLogSuppressExcl
  );
    ...
    [this](const EsDlgBase& Sender, int modalResult)
  {
    if(wxID_OK == modalResult)
    {
      const EsDbgLogRulesDlg& dlg = dynamic_cast<const EsDbgLogRulesDlg&>(Sender);
      EsScriptParameters& params = wxGetApp().scriptParamsAccess();
      params.m_dbgLogSuppressInclFirst = dlg.inclIsFirstGet();
      params.m_dbgLogSuppressIncl = dlg.rulesInclGet();
      params.m_dbgLogSuppressExcl = dlg.rulesExclGet();
...
void EsSconsoleMain::onHelpDocument(wxCommandEvent& evt)
{
  ...
  if(!type)
  {
    wxLogWarning(
      wxString::Format(
        _("Could not open help file '%s', no applicable viewer application is found for extension '%s'").as<wxString>(),
        file,
        esT("PDF")
      )
    );
  ...
  if(cmd.IsEmpty())
  {
    wxLogWarning(
      wxString::Format(
        _("Could not find OPEN verb for a help file '%s'").as<wxString>(),
        file
      )
    );
    return;
...
void EsSconsoleMain::documentFileOpen(std::set<EsString>& banNextTime, const EsString& type, const EsString& fpath, const EsVariant& params)
{
  ...
  if(!EsPath::fileExists(fpath, EsString::null()))
  {
    wxMessageBox(
      wxString::Format(
        _("Could not open document '%s',\nfile does not exist").as<wxString>(),
        fpath.as<wxString>()
      ),
      _("Document is not found").as<wxString>(),
...
void EsSconsoleMain::currentDocViewChangeCheck()
{
  ...
  if(m_activeView != view)
  {
    ...
    wxMenuItem* item = m_mnuEdit->FindChildItem(usrID_EDIT_CUSTOM_CTX_MENU);
    if(item)
      m_mnuEdit->Destroy(item);
    ...
    if(txtView)
    {
      ...
      wxMenuSharedPtr customCtx = txtView->customCtxMenuGet();
      if(customCtx)
      {
        ...
        item = m_mnuEdit->AppendSubMenu(
          ctxMenu.release(),
          _("Advanced").as<wxString>(),
          _("Advanced editor commands").as<wxString>()
        );
        ES_ASSERT(item);
...
int EsSconsoleMain::selectNewFilePath(const EsDocumentIntf::Ptr& doc, EsString& newPath)
{
  ...
  wxFileDialog dlgSave(
    this,
    wxString::Format(
      _("Save '%s'").as<wxString>(),
      key.as<wxString>()
    ),
    wxEmptyString,
    wxEmptyString,
    regInfo[esVT("filterStr")][1].asString().as<wxString>(),
    wxFD_SAVE | wxFD_OVERWRITE_PROMPT | wxFD_CHANGE_DIR | wxFD_NO_FOLLOW,
    wxDefaultPosition,
    wxDefaultSize
  );

  wxFileName fname(key.as<wxString>());
  ...
  if(doc->isModified() || (flags & SaveAs))
  {
    if(doc->isModified() && (flags & PromptSaveModified))
    {
      int response = wxMessageBox(
        wxString::Format(
          _("Document '%s' have unsaved changes.\nDo you want to save it?").as<wxString>(),
          doc->keyGet().asString().as<wxString>()
        ),
        _("Save document").as<wxString>(),
...
_re_query_new_path:
      ...
      if(!m_mgrMdi->documentFind(newPath).isEmpty())
      {
        wxMessageBox(
          wxString::Format(
            _("Document '%s' could not be saved to '%s',\nbecause it is already open in another window.").as<wxString>(),
            doc->keyGet().asString().as<wxString>(),
            newPath.as<wxString>()
          ),
          _("Document already open").as<wxString>(),
...
void EsSconsoleMain::commonAppSettingsApply(bool doSave /*= false*/)
{
  ...
  const EsScriptParameters& params = wxGetApp().scriptParamsAccess();
  EsScriptIntf::Ptr bin = m_compiler.binaryGet();
  EsScript* script = ES_INTFPTR_TO_OBJECTPTR<EsScript>(bin);
  ES_ASSERT(script);

  script->parametersSet(params);
  ...
  if(bindoc)
  {
    ...
    script = ES_INTFPTR_TO_OBJECTPTR<EsScript>(bin);
    ES_ASSERT(script);
