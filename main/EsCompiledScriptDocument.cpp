...
EsVariant EsCompiledScriptDocument::NEW(cr_EsVariant ES_UNUSED(regInfo))
{
  EsDocumentIntf::Ptr obj(
    new EsCompiledScriptDocument
  );
  ES_ASSERT(obj);
...
void EsCompiledScriptDocument::emptyContentsInit()
{
...
void EsCompiledScriptDocument::doWrite(cr_EsVariant target, cr_EsVariant params)
{
  // Interpret src as script file path
