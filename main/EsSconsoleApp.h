...
public:
  ...
  EsScriptParameters& scriptParamsAccess() ES_NOTHROW { return m_params; }

  /// Command line parameters access
  const EsSconsoleCommandLineParams& cmdlineParamsGet() const ES_NOTHROW { return m_cmdParams; }
